...
struct thread
  {
    ...
    struct lock *waiting;                //the lock the thread is currently waiting for
...
bool thread_bigger_compare(struct list_elem *a, struct list_elem *b, void *aux); //Sorting any list of threads
